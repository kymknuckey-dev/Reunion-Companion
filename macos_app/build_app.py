...
APP_VERSION="2.0"
APP_BUILD="6"
APP_RELEASE="FFD 2.0 RC1.0.7 — Person Presentation & Application Navigation — Person Presentation QA Pass 2"
...
""")
    ...
    entry.write_text(
        ...
        "    HTML(string='<h1>Reunion Companion PDF Runtime</h1><p>Frozen runtime test.</p>').write_pdf(str(p))\n"
