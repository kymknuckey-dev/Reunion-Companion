...
def test_identity(): assert m.APP_BUILD=="2" and m.ENGINE_BASELINE=="FFD 1.9 RC1"
def test_webkit():
...
def test_shell_identity():
 from reunion_companion import app_identity; assert app_identity.APP_DISPLAY=="FFD 2.0 Build 2" and app_identity.ENGINE_BASELINE=="FFD 1.9 RC1"
