...
def test_identity_preserves_frozen_engine():
    assert m.APP_BUILD=="4"
    assert m.APP_RELEASE=="FFD 2.0 Build 4 — Self-Contained Application Runtime"
...
def test_diagnostics_exposes_runtime_location():
    ...
    assert "Self-Contained Application Runtime" in s
...
def test_shell_identity():
    ...
    assert app_identity.APP_DISPLAY=="FFD 2.0 Build 4"
    assert app_identity.APP_RELEASE_NAME=="Self-Contained Application Runtime"
